...
public class QuarkusDataAuditDataIsolationIT {

    private static final String ALLOWED_PROCESS_ID = "allowedProcess";
    private static final String ALLOWED_PROCESS_VERSION = "1.0";
    private static final String OTHER_PROCESS_ID = "otherProcess";
    private static final String OTHER_PROCESS_VERSION = "1.0";
    ...
    public void init() {
        ...
        ProcessInstanceStateDataEvent allowedEvent = newProcessInstanceStateEvent(
                ALLOWED_PROCESS_ID, "pi-allowed-1",
    ...
    @Test
    public void testGetAllProcessInstancesStateByProcessIdReturnsOnlyAllowedProcesses() {
        List<Map<String, Object>> result = given()
                .contentType(ContentType.JSON)
    ...
    @Test
    public void testOtherProcessNotReturnedWhenQueried() {
        // Even if a caller explicitly queries for the OTHER process id, it must be filtered out
        List<Map<String, Object>> result = given()
                .contentType(ContentType.JSON)
