...
/**
 * Quarkus test profile for the data-audit IT tests.
 *
 * Enables data isolation and exposes two stub processes:
 * <ul>
 * <li>{@code itAllowedProcess} / 1.0 — used by process-instance isolation ITs</li>
 * <li>{@code itJobProcess} / 1.0 — used by job isolation ITs</li>
 * </ul>
 */
public class DataAuditITTestProfile implements QuarkusTestProfile {
    ...
    /** Minimal stub that only exposes id() and version(); all other operations throw. */
